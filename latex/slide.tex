...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[width=0.13\linewidth]{pic/cumtlogo.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}{用Beamer很高大上？}
    \begin{itemize}[<+-| alert@+>] % 当然，除了alert，手动在里面插 \pause 也行
        ...
        \item Overleaf项目地址在\url{https://www.overleaf.com/latex/templates/CUMT-beamer-theme/ybqzdsgvrfdq}，可以直接使用
    \end{itemize}
\end{frame}
